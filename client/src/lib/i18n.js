...
opp_email_help_alt: "Отвори в имейл приложение",
    ...
    hero_order_locked_title: "Поръчките се отварят на 30 април в 18:00",
    hero_order_open_title: "Отвори магазина",
    hero_order_locked: "Поръчка на 30 април, 18:00 🔒",
    hero_order_now: "Поръчай сега ⚡",
    hero_scroll_down: "Скролни надолу ↓",
    home_spotify_title: "Заявка за Spotify плейлист 🎵",
    home_spotify_open: "Отвори Spotify плейлист",
    home_spotify_not_set: "Линкът за плейлиста още не е зададен.",
    home_spotify_limit: "1 заявка на ден.",
    home_spotify_song: "Песен",
    home_spotify_artist: "Изпълнител",
    home_spotify_send: "Изпрати заявка",
    home_games_title: "Игри хъб 🎮",
    home_games_label: "Игра",
    home_games_word: "Word игра",
    home_games_play: "Играй",
    home_games_board: "Класация",
    home_games_note: "Подготвяме поддръжка и за още игри.",
...
profile_2fa_active: "✅ 2FA е активирано",
    ...
    profile: "Профил",
    write: "Публикувай",
    write_title: "Публикувай статия",
    write_subtitle: "Сподели твоята история с общността на MIREN.",
    write_rules_btn: "Правила и условия",
    write_name_label: "Твоето име (автор)",
    write_title_label: "Заглавие",
    write_body_label: "Съдържание",
    write_cover_label: "Снимка — начало",
    write_end_label: "Снимка — край (по избор)",
    write_submit: "Изпрати за одобрение",
    write_submitting: "Изпращане...",
    write_success: "✅ Изпратено! Екипът на MIREN ще прегледа статията ти.",
    write_login_required: "Трябва да си влязъл в профила си.",
    write_premium_note: "За да бъдеш публикуван в хартиеното списание, трябва да имаш или да си имал Premium абонамент.",
    write_leaderboard_note: "Топ писателите получават награди между релийзовете на списанието.",
    write_rules_title: "Правила за публикуване",
...
opp_email_help_alt: "Open in email app",
    ...
    hero_order_locked_title: "Orders open on 30 April at 18:00",
    hero_order_open_title: "Open store",
    hero_order_locked: "Order on 30 April, 18:00 🔒",
    hero_order_now: "Order Now ⚡",
    hero_scroll_down: "Scroll down ↓",
    home_spotify_title: "Spotify Playlist Request 🎵",
    home_spotify_open: "Open Spotify Playlist",
    home_spotify_not_set: "Playlist link is not set yet.",
    home_spotify_limit: "1 request per day.",
    home_spotify_song: "Song",
    home_spotify_artist: "Artist",
    home_spotify_send: "Send request",
    home_games_title: "Games Hub 🎮",
    home_games_label: "Game",
    home_games_word: "Word Game",
    home_games_play: "Play",
    home_games_board: "Leaderboard",
    home_games_note: "Ready for multi-game support later.",
...
profile_2fa_active: "✅ Two-Factor Authentication is Active",
    ...
    profile: "Profile",
    write: "Publish",
    write_title: "Publish an Article",
    write_subtitle: "Share your story with the MIREN community.",
    write_rules_btn: "Rules & Terms",
    write_name_label: "Your name (author)",
    write_title_label: "Title",
    write_body_label: "Content",
    write_cover_label: "Cover image",
    write_end_label: "Closing image (optional)",
    write_submit: "Submit for approval",
    write_submitting: "Submitting...",
    write_success: "✅ Submitted! The MIREN team will review your article.",
    write_login_required: "You must be logged in.",
    write_premium_note: "To be published in the print magazine, you need an active or past Premium subscription.",
    write_leaderboard_note: "Top writers receive rewards between magazine releases.",
    write_rules_title: "Publishing Rules",
