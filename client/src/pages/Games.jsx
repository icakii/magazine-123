...
export default function Games() {
  ...
  const EASY_WORDS = [
    ...
    "SUNNY","BLOOM","BROOM","BROTH","CHUNK","CLOWN","CRUST","DAISY","DELVE","DIRTY",
    "DIVER","DUSTY","DWELL","ELBOW","ENDOW","FEAST","FERRY","FLAIR","FLANK","FLESH",
    "FLOCK","FROWN","FRUGAL","GLARE","GLEAM","GLINT","GLOAT","GLOOM","GLOSS","GOING",
    "GREED","GREET","GRILL","GRIPE","GROAN","GROWL","GRUFF","GUAVA","GULCH","HURDLE",
    "INLET","INSET","INTER","INTRO","ISLET","JELLY","JERKY","JOLLY","JOUST","JUMBLE",
    "KARMA","KAYAK","KNACK","KNEEL","KNELT","LATCH","LATTE","LAUGHS","LEAFY","LEAPT",
    "LILAC","LINER","LITHE","LOFTY","LORRY","LOTUS","LOWLY","LUSTY","LYRIC","MANOR",
    ...
    "SCRUB","SEEDY","SEVER","SHADY","SHAWL","SHEEN","SHEIK","SHELF","SLANG","SLANT",
    ...
    "STAIN","STALE","STALL","STAMP","STASH","STAVE","STEAD","STEAL","STEAK","STEEP",
    "STERN","STOMP","STOOL","STOOP","STORE","STOUT","STRAP","STRAY","STRIP","STRUT",
  ]
