      ...
      <div className="hero-inner">
        ...
        <div className="hero-copy">
          ...
          <div className="hero-title-row">
            ...
            <div className="insta-tooltip-container">
              <div className="insta-tooltip">
                <div className="insta-profile">
                  <div className="insta-user">
                    <div className="insta-img">
                      <img src="/logo12345.png" alt="MIREN logo" />
                    </div>
                    <div className="insta-details">
                      <div className="insta-name">M!REN</div>
                      <div className="insta-username">@miren_magazine</div>
                    </div>
                  </div>
                  <div className="insta-about">300+ Followers</div>
                </div>
              </div>
              <a
                className="insta-icon"
                href="https://www.instagram.com/miren_magazine/"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Instagram @miren_magazine"
              >
                <div className="insta-layer">
                  <span></span><span></span><span></span><span></span>
                  <span className="insta-bg">
                    <svg fill="white" viewBox="0 0 448 512" height="1.4em" xmlns="http://www.w3.org/2000/svg">
